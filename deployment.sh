#
#    deployment.sh is part of Demo MisionTIC-2021 C4, created by Carlos Andrés Sierra.
#
...
sudo heroku login
sudo heroku create misiontic-2021-auth-ms
sudo heroku container:login
sudo heroku container:push web --app misiontic-2021-auth-ms
sudo heroku container:release web --app misiontic-2021-auth-ms